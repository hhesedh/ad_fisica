...
$ E_{pg} = m \times g \times h$ \\
 ...
 $E_{c} = m \times \dfrac{v^2}{2}$\\
 
 $g = 10  m/s^2$ \\
 
 então $E_{MA} =  m \times g \times (5,5) +  m \times \dfrac{v^2}{2}$ \\
 
$E_{MC}  =  m \times g \times (10)$ \\

$E_{MA} = E_{MB} \rightarrow  m \times g \times (5,5) + m \times \dfrac{v_{0}^{\,\,2}}{m \times g \times (10)}$ \\

$\dfrac{v_{0}{\,\,2}}{2} =  10 \times g - 5,5 \times g$ \\

$\dfrac{v_{0}{\,\,2}}{2} =  4,5 \times g$ \\

$v_{0}^{\,\,2} = 9 \times g$ \\

$v_{0}^{\,\,2} = \sqrt{ 9 \times g}$ \\

$v_{0}^{\,\,2} = 3 \sqrt{g} $ \\

$v_{0}^{\,\,2} = 3 \sqrt{10}$ \\

$v_{0}^{\,\,2} = 9.48683298051 m/s$ \\

Resposta: A menor rapidez $v_0$ necessária para que o carrinho ultrapasse o topo da elevação é: $9.48683298051 m/s$\\

% letra B
\item  Não, pois a velocidade adquirida depende apenas da diferença de altura entre as duas elevações.
